...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg-full-width.bg-color-1
      .px-4.px-md-5.py-4
        .row.mb-5
          .col-lg-4.order-lg-2.mb-3.mb-lg-0(data-aos="fade-right")
            figure
